...
kn service create image --image h2non/imaginary --arg="-enable-url-source" --concurrency-limit=10 # eger Zero olmasın cold-start biraz hızlı olsun isteniyorsa     "--scale-min=1" ekleyebiliriz. Disable Scale-to-Zero
